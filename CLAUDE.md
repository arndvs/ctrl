<!-- GENERATED FILE — do not edit directly.
     This is generated by bootstrap.sh from CLAUDE.base.md + local instruction refs.
     Edit CLAUDE.base.md instead, then run: bash ~/dotfiles/bin/bootstrap.sh -->
...
@~/dotfiles/instructions/\_local/copywriting.instructions.md
